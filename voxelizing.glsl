...
#define VISUALIZED_DATA 4 //[0 1 2 3 4]
	...
	vec4 voxel_data = mc_Entity.x == 1.0 ? vec4(1.0,0.0,0.0,1.0) : mc_Entity.x == 2.0 ? vec4(0.0,0.0,1.0,1.0) : mc_Entity.x == 3.0 ? vec4(1.0,1.0,0.0,1.0) : mc_Entity.x == 4.0 ? vec4(0.0,1.0,0.0,1.0) : vec4(0.0);
#endif
